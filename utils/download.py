...
DOWNLOAD_CHOICES = list(TASKS.keys())
...
def download(tasks: str, *, openml_cache_dir: Path | None = None) -> None:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--tasks", choices=DOWNLOAD_CHOICES, type=str, default=DOWNLOAD_CHOICES[2], required=False)
    parser.add_argument("--openml-cache-dir", type=Path, default= "./.openml-cache/", required=False)
